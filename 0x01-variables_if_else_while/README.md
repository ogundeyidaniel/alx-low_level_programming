...
05 You are not allowed to use any variable of type char
...
06 You can only use the putchar function (every other function (printf, puts, etc…) is forbidden)
All your code should be in the main function
You can only use putchar twice in your code
8-print_base16.c: Hexadecimal
Write a program that prints all the numbers of base 16 in lowercase, followed by a new line.

07 You can only use the putchar function (every other function (printf, puts, etc…) is forbidden)
All your code should be in the main function
You can only use putchar three times in your code
9-print_comb.c: Patience, persistence and perspiration make an unbeatable combination for success
Write a program that prints all possible combinations of single-digit numbers.

08 Numbers must be separated by ',', followed by a space ' '
...
09 Numbers must be separated by ',', followed by a space ' '
...
10 Numbers must be separated by ',', followed by a space*' '*
...
11 Numbers must be separated by ',', followed by a space ' '
...
12 The numbers should range from 0 to 99
...
You are not allowed to use any variable of type char
All your code should be in the main function Footer
